...
namespace BlueAcorn\ZipcodeValidation\Plugin;
...
class CheckoutProcessor
{
    ...
    public function afterProcess(\Magento\Checkout\Block\Checkout\LayoutProcessor $processor, $jsLayout)
    {
        ...
        $postCodeComponent = 'BlueAcorn_ZipcodeValidation/js/form/element/post-code';
        $postCodeValidation = [
        ...
        $cityField = [
                'component' => 'BlueAcorn_ZipcodeValidation/js/form/element/city',
                'config' => [
